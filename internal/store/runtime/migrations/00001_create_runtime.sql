...
DROP TABLE IF EXISTS container_dsn_entries;
DROP TABLE IF EXISTS project_excluded_containers;
DROP TABLE IF EXISTS project_nodelets;
DROP TABLE IF EXISTS projects;
DROP INDEX IF EXISTS idx_mcp_connections_container_binding;
DROP TABLE IF EXISTS mcp_connections;
DROP TABLE IF EXISTS nodelets;

...
func FromInvokableTool(ctx context.Context, invokable einotool.InvokableTool) (toolruntime.Tool, protocol.ToolDefinition, error) {
...
func (t *invokableAdapter) Definition() protocol.ToolDefinition {
	return protocol.CloneTools([]protocol.ToolDefinition{t.definition})[0]
}

func (t *invokableAdapter) ExecutionMode() toolruntime.ExecutionMode {
	return toolruntime.ExecutionModeParallel
}

func (t *invokableAdapter) PrepareArguments(_ context.Context, raw json.RawMessage) (json.RawMessage, error) {
	out := make(json.RawMessage, len(raw))
	copy(out, raw)
	return out, nil
}

func (t *invokableAdapter) Execute(ctx context.Context, call toolruntime.ToolCall, _ toolruntime.ToolUpdateSink) (protocol.ToolResult, error) {

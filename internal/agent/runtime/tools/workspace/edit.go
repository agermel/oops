...
func newEditTool(cfg workspaceToolConfig) toolruntime.Tool {
...
func (t *editTool) Execute(ctx context.Context, call toolruntime.ToolCall, _ toolruntime.ToolUpdateSink) (protocol.ToolResult, error) {

...
func TestClientNew(t *testing.T) {
	...
	client, err := NewClient(context.Background(), cfg, ClientOptions{})
	if err != nil {
...
func TestClientUsesInjectedCredentialStore(t *testing.T) {
...
func TestClientFiltersCurrentToolsWithDisabledState(t *testing.T) {

...
func newWriteTool(cfg config) toolruntime.Tool {
...
func (t *writeTool) Execute(_ context.Context, call toolruntime.ToolCall, _ toolruntime.ToolUpdateSink) (protocol.ToolResult, error) {
